...
struct HistogramData {
  ...
  double percentile95;
  double percentile99;
  // High-percentile values for fine-grained tail latency analysis.
  double percentile999 = 0.0;    // P99.9
  double percentile9999 = 0.0;   // P99.99
  double percentile99999 = 0.0;  // P99.999
  double average;
