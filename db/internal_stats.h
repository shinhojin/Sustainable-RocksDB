...
class InternalStats {
 ...
 private:
  ...
  bool HandleEstimatePendingCompactionBytes(uint64_t* value, DBImpl* db,
                                            Version* version);
  bool HandleRLL0FileCount(uint64_t* value, DBImpl* db, Version* version);
  bool HandleRLImmMemtableBytes(uint64_t* value, DBImpl* db, Version* version);
  bool HandleRLWriteLatP99(uint64_t* value, DBImpl* db, Version* version);
  bool HandleRLWriteInBytesPerSec(uint64_t* value, DBImpl* db, Version* version);
  bool HandleRLTruePendingFlushBytes(uint64_t* value, DBImpl* db,
                                     Version* version);
  bool HandleRLTruePendingCompactionBytes(uint64_t* value, DBImpl* db,
                                          Version* version);
  bool HandleRLTrainingEnabled(uint64_t* value, DBImpl* db, Version* version);
  bool HandleRLMetricsEnabled(uint64_t* value, DBImpl* db, Version* version);
