...
void BuildDBOptions(const ImmutableDBOptions& immutable_db_options,
  ...
  options.rl_enable_metrics = immutable_db_options.rl_enable_metrics;
  options.rl_metrics_period_ms = immutable_db_options.rl_metrics_period_ms;
  options.rl_log_sampled_metrics = immutable_db_options.rl_log_sampled_metrics;
  options.rl_enable_write_throttling =
      immutable_db_options.rl_enable_write_throttling;
  options.rl_write_base_rate_bytes_per_sec =
      immutable_db_options.rl_write_base_rate_bytes_per_sec;
  options.rl_write_m_min = immutable_db_options.rl_write_m_min;
  options.rl_write_delta_max = immutable_db_options.rl_write_delta_max;
  options.rl_write_emergency_override =
      immutable_db_options.rl_write_emergency_override;
  options.rl_write_emergency_safe_multiplier =
      immutable_db_options.rl_write_emergency_safe_multiplier;
  options.rl_enable_training_instrumentation =
      immutable_db_options.rl_enable_training_instrumentation;
}
