    ...
    db_immutable_options_type_info = {
        ...
        {"persist_stats_to_disk",
         {offsetof(struct ImmutableDBOptions, persist_stats_to_disk),
          ...
          OptionTypeFlags::kNone}},
        {"rl_enable_metrics",
         {offsetof(struct ImmutableDBOptions, rl_enable_metrics),
          OptionType::kBoolean, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_metrics_period_ms",
         {offsetof(struct ImmutableDBOptions, rl_metrics_period_ms),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_log_sampled_metrics",
         {offsetof(struct ImmutableDBOptions, rl_log_sampled_metrics),
          OptionType::kBoolean, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_enable_write_throttling",
         {offsetof(struct ImmutableDBOptions, rl_enable_write_throttling),
          OptionType::kBoolean, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_write_base_rate_bytes_per_sec",
         {offsetof(struct ImmutableDBOptions,
                   rl_write_base_rate_bytes_per_sec),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_write_m_min",
         {offsetof(struct ImmutableDBOptions, rl_write_m_min),
          OptionType::kDouble, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_write_delta_max",
         {offsetof(struct ImmutableDBOptions, rl_write_delta_max),
          OptionType::kDouble, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_write_emergency_override",
         {offsetof(struct ImmutableDBOptions, rl_write_emergency_override),
          OptionType::kBoolean, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_write_emergency_safe_multiplier",
         {offsetof(struct ImmutableDBOptions,
                   rl_write_emergency_safe_multiplier),
          OptionType::kDouble, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"rl_enable_training_instrumentation",
         {offsetof(struct ImmutableDBOptions,
                   rl_enable_training_instrumentation),
          OptionType::kBoolean, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
      ...
      rl_enable_metrics(options.rl_enable_metrics),
      rl_metrics_period_ms(options.rl_metrics_period_ms),
      rl_log_sampled_metrics(options.rl_log_sampled_metrics),
      rl_enable_write_throttling(options.rl_enable_write_throttling),
      rl_write_base_rate_bytes_per_sec(
          options.rl_write_base_rate_bytes_per_sec),
      rl_write_m_min(options.rl_write_m_min),
      rl_write_delta_max(options.rl_write_delta_max),
      rl_write_emergency_override(options.rl_write_emergency_override),
      rl_write_emergency_safe_multiplier(
          options.rl_write_emergency_safe_multiplier),
      rl_enable_training_instrumentation(
          options.rl_enable_training_instrumentation) {
...
void ImmutableDBOptions::Dump(Logger* log) const {
  ...
  ROCKS_LOG_HEADER(log, "                Options.persist_stats_to_disk: %u",
                   persist_stats_to_disk);
  ROCKS_LOG_HEADER(log, "                Options.rl_enable_metrics: %d",
                   rl_enable_metrics);
  ROCKS_LOG_HEADER(log, "        Options.rl_metrics_period_ms: %" PRIu64,
                   rl_metrics_period_ms);
  ROCKS_LOG_HEADER(log, "            Options.rl_log_sampled_metrics: %d",
                   rl_log_sampled_metrics);
  ROCKS_LOG_HEADER(log, "            Options.rl_enable_write_throttling: %d",
                   rl_enable_write_throttling);
  ROCKS_LOG_HEADER(
      log, "      Options.rl_write_base_rate_bytes_per_sec: %" PRIu64,
      rl_write_base_rate_bytes_per_sec);
  ROCKS_LOG_HEADER(log, "            Options.rl_write_m_min: %.3f",
                   rl_write_m_min);
  ROCKS_LOG_HEADER(log, "            Options.rl_write_delta_max: %.3f",
                   rl_write_delta_max);
  ROCKS_LOG_HEADER(log, "            Options.rl_write_emergency_override: %d",
                   rl_write_emergency_override);
  ROCKS_LOG_HEADER(
      log, "      Options.rl_write_emergency_safe_multiplier: %.3f",
      rl_write_emergency_safe_multiplier);
  ROCKS_LOG_HEADER(log,
                   "        Options.rl_enable_training_instrumentation: %d",
                   rl_enable_training_instrumentation);
