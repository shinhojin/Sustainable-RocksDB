...
struct ImmutableDBOptions {
  ...
  bool rl_enable_metrics;
  uint64_t rl_metrics_period_ms;
  bool rl_log_sampled_metrics;
  bool rl_enable_write_throttling;
  uint64_t rl_write_base_rate_bytes_per_sec;
  double rl_write_m_min;
  double rl_write_delta_max;
  bool rl_write_emergency_override;
  double rl_write_emergency_safe_multiplier;
  bool rl_enable_training_instrumentation;
